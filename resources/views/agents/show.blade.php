                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            @if($agent->photo)
                                <img src="{{ asset('public/agents_photos' . $agent->photo) }}" alt="Photo de {{ $agent->last_name }} {{ $agent->first_name }} " class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
                            @else
